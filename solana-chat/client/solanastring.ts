...
export async function getProgram(connection: Connection, program_keypair_path:string): Promise<Keypair> {
...
export async function sendMessage(connection: Connection, account: Keypair, seededAccount: PublicKey, programId: PublicKey, str: string): Promise<TransactionSignature> {
...
export async function getChat(connection: Connection, seededAccount: PublicKey): Promise<string> {
